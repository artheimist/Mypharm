...
<body>
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-light bg-light navanimate">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarsExample07">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link " aria-current="page" href="<?= base_url('after_shop') ?>">Shop</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active text-primary" aria-current="page" href="#">Artikel</a>
          </li>
          <li class="nav-item">
